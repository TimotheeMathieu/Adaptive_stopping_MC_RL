...
Denote $E_{i}^{i+j}=(E_i, E_{i+1},\dots, E_{i+j})$ and let $T_n$ be a statistic on $\R^{2n}$ (typically $T_n(Z_1,\dots,Z_{2n})=\frac{1}{n}\sum_{i=1}^n Z_i -\frac{1}{n}\sum_{i=n+1}^{2n} Z_i$). Denote by 
$$\widehat{R}_{n,k}(t)=\frac{1}{n!}\sum_{\sigma \in S_n} \1\{T_n(\sigma E_{2nk}^{2n(k+1)}) \le t\} $$
