...
$$\P_\sigma(nT_n(\sigma E_{2n}^{4n})+nT_n(\sigma E_1^{2n})\le b_2_{-}, b_1^{+}\le nT_n(\sigma E_1^{2n})\le b_1^{-}  ) = q_2^{-} \le \frac{1}{2}\alpha\left(\frac{2}{K}\right) $$
$$\P_\sigma(nT_n(\sigma E_{2n}^{4n})+nT_n(\sigma E_1^{2n})\ge b_2_{+}, b_1^{+}\le nT_n(\sigma E_1^{2n})\le b_1^{-}  ) = q_2^{+} \le \frac{1}{2}\alpha\left(\frac{2}{K}\right) $$
