...
set_level('ERROR') # remove logging for rlberry to avoid clutter
...
if __name__ == "__main__":
    ...
    with open("results/multi_complementary.txt", "w") as f:
        f.write("For M = {}, we get FWE = {}, FWE for means={}".format(M, FWE, FWE_means))
